# app.py - Streamlit Deployment UI for Client 28
import streamlit as st
import os
from PIL import Image
from predict import predict_single_image

st.set_page_config(page_title="Height Detector Portal 28", page_icon="☀️")
st.title("☀️ Space Tracker Console — Version 28")
st.sidebar.info("Backbone: Custom_Inception_Lite\nTheme Style: Orange")
